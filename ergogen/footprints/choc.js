...
module.exports = {
  ...
  body: (p) => {
    const standard = `
      ...
      (model \${ERGOGEN_MODELS}/SW_Kailh_Choc_V1.wrl
        (at (xyz 0 0 0))
        (scale (xyz 1 1 1))
        (rotate (xyz 0 0 0))
      )
    ...
    function pins(def_neg, def_pos, def_side) {
      if (p.hotswap) {
        return `
          ...
          ${"" /* net pads */}
          (pad 1 smd rect (at ${def_neg}3.275 -5.95 ${p.r
          }) (size 2.6 2.6) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask)  ${p.from
          })
          (pad 2 smd rect (at ${def_pos}8.275 -3.75 ${p.r
          }) (size 2.6 2.6) (layers ${def_side}.Cu ${def_side}.Paste ${def_side}.Mask)  ${p.to
          })
        `;
      } else {
        return `
